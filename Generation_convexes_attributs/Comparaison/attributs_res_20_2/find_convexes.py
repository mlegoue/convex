...
with open('time_find_convex.csv', 'w', newline='') as csvfilefc :
    ...
    with open('time_attributs_subset.csv', 'w', newline='') as csvfilecs:
        ...
        for n in range(2, 21):
            ...
            time1.append(somme1/200)
            time2.append(somme2/200)
...
plt.plot(x, time1, label='new find attributes')
plt.plot(x, time2, label='old find attributes')
plt.xlabel("Nombre de noeuds")
plt.ylabel("Temps en s")
plt.title("Comparaison du temps d'execution moyen sur 200 graphes de Erdos-Renyi avec p = 0.5")
plt.legend()
