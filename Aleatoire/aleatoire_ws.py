...
for n in range(16, 25):
    for m in range(2, n):
        for p in range(1, 10):
            ...
            for i in range(100):
                if not os.path.exists("Watts_Strogatz/n" + str(n) + "m" + str(m) + "p" + str(p / 10) + '/nb' + str(i)):
                    os.makedirs("Watts_Strogatz/n" + str(n) + "m" + str(m) + "p" + str(p / 10) + '/nb' + str(i))
                G = nx.connected_watts_strogatz_graph(n, m, p/10)
                print(n, m, p/10, i)
                convexes, attributs = find_attributs(G)
                with open("Watts_Strogatz/n" + str(n) + "m" + str(m) + "p" + str(p/10) + '/nb' + str(i) + '/attributs.csv', 'w', newline='') as csvfile:
                ...
                with open("Watts_Strogatz/n" + str(n) + "m" + str(m) + "p" + str(p/10) + '/nb' + str(i) + '/data.txt', 'w') as outfile:
